	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-card': 'linear-gradient(135deg, rgba(255,255,255,0.9) 0%, rgba(251,146,60,0.05) 100%)',
				'gradient-hover': 'linear-gradient(135deg, rgba(251,146,60,0.1) 0%, rgba(234,88,12,0.1) 100%)',
			},
			colors: {
